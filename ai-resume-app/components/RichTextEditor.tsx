...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ value, onChange }) => {
  ...
  const handleGenerate = async () => {
    if (!resumeContext?.resumeInfo?.summery) {
      toast.error("Resume summary is empty. Please fill it first.");
      return;
    }

    const resumeSummary = resumeContext.resumeInfo.summery;
...
<ol>
  ...
  ...
      ...
      // Because you expect one text response (not JSON), you can just fetch the raw text
