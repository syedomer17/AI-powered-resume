        ...
        <div className="flex flex-wrap justify-center items-center gap-2 text-[11px] mb-2">
          {resumeInfo?.linkedIn && (
            <>
              ...
              >
                ...
                <span className="text-blue-700">{resumeInfo.linkedInUsername || "LinkedIn"}</span>
              </a>
          ...
          {resumeInfo?.github && (
            <>
              ...
              >
                ...
                <span className="text-blue-700">{resumeInfo.githubUsername || "GitHub"}</span>
              </a>
          ...
          {resumeInfo?.twitter && (
            <>
              ...
              >
                ...
                <span className="text-blue-700">{resumeInfo.twitterUsername || "Twitter"}</span>
              </a>
          ...
          {resumeInfo?.medium && (
            ...
            >
              ...
              <span className="text-blue-700">{resumeInfo.mediumUsername || "Medium"}</span>
            </a>
          )}
        </div>
      )}
